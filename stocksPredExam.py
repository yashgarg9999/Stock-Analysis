...
def predict_prices(dates, prices, x):
	...
	print("--- Polynomial Fit Complete in %s seconds ---" %(time.time() - start_time))
	print("\n")
	start_time = time.time()
